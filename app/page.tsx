...
export default async function Home() {
  ...
  return (
    <main className="@container flex min-h-screen w-full flex-col items-center justify-between">
      <div className="w-full h-250 flex overflow-hidden items-center justify-between relative">
        ...
        <div className="absolute flex top-20 bottom-10 flex-col items-left justify-left px-8 gap-3">
          ...
          />
          <h1 className="text-9xl @sm:text-6xl font-extrabold font-[Fugaz_One] text-[#0a1f41] overline">
            ONLINE <br />
            GUITAR <br />
            LESSONS
          </h1>
          <h4 className="font-bold text-xl @sm:text-lg text-gray-800 mt-4">
      ...
      <div className="w-full h-auto px-6 py-6 bg-white">
        <h1 className="text-7xl @sm:text-5xl font-extrabold text-[#0a1f41] text-center mt-12">
          Unlock Your Slide Guitar <br /> Learning Journey at Learn Guitar Cafe
        </h1>
        <p className="text-3xl @sm:text-2xl leading-10 text-[#0a1f41] text-center mt-6 break-word">
        ...
        <p className="text-3xl @sm:text-2xl leading-10 text-[#0a1f41] text-center mt-6 mb-5 break-word">
        ...
        <div className="w-full flex @sm:flex-col flex-row items-center justify-center mt-6">
          <div className="w-1/3 @sm:w-full h-auto p-6">
          ...
          <div className="w-2/3 h-auto p-6 @sm:order-first @sm:w-full">
            <img
      ...
      <div className="grid grid-cols-2 @sm:grid-cols-1 w-full p-10 gap-10">
        {courses
      ...
      <div className="w-full h-auto px-6 py-6 bg-[#f9f9f9] mb-6">
        <div className="flex @sm:flex-col flex-row items-center justify-center gap-6">
          <div className="px-6 py-6 w-2/3 @sm:w-full">
            <h4 className="text-3xl leading-10 font-medium text-[#0a1f41] text-left mt-6 mb-5 @sm:w-full @sm:leading-8">
          ...
          <img
            ...
            className="w-1/3 h-auto object-cover rounded-lg @sm:order-first @sm:w-full"
          />
        </div>
      </div>
